...
- Install Ubuntu Desktop on Raspberry Pi on Micro SD Card
...
- Connect Keyboard, Mouse, External Monitor (Micro HDMI to Regular HDMI) before power up the Raspberry Pi
    
- After power up the Raspberry Pi it should boot up the Ubuntu Server
...
- Run `cd src/` then Clone these repositories in the src:
	- git clone [https://github.com/yujinrobot/kobuki.git](https://github.com/yujinrobot/kobuki.git)
	- git clone [https://github.com/turtlebot/turtlebot.git](https://github.com/turtlebot/turtlebot.git)
	- git clone [https://github.com/yujinrobot/yujin_ocs.git](https://github.com/yujinrobot/yujin_ocs.git)
	- git clone [https://github.com/turtlebot/turtlebot_msgs.git](https://github.com/turtlebot/turtlebot_msgs.git)
	- git clone [https://github.com/turtlebot/turtlebot_apps.git](https://github.com/turtlebot/turtlebot_apps.git)
	- git clone [https://github.com/turtlebot/turtlebot_simulator.git](https://github.com/turtlebot/turtlebot_simulator.git)
- Configuration 
...
- lsusb (To check that TurtleBot is connected or not)
...
- Install the dependencies in your workspace (folder src in kobuki_ws)
...
- git clone [https://github.com/ros-drivers/freenect_stack.git](https://github.com/ros-drivers/freenect_stack.git)
...
Communication between 2 or more Raspberry Pi:
...
Control 2 TurtleBot at the same time:

- Assumed Rasp1 is master (talker) and Rasp 2, 3 is a subscriber (listener). Control TurtleBot (Rasp 2, 3) by using Rasp 1
...
- roslaunch turtlebot_bringup minimal.launch __ns:=<turtlebotname>, need this command because to control 2 TurtleBot at the same time need the different name of node
...
- roslaunch turtlebot_bringup minimal.launch __ns:=<turtlebotname>, need this command because to control 2 TurtleBot at the same time need the different name of the node
