...
**Chester** - 
- **Introduction:** I'm Chesturinat, I'm an undergrads internship student from Thailand. I'm working on a research project focusing on TurtleBot.
- **Accomplishments:** I use LiDAR to map the environment instead of Kinect. Thank you to Austin, he set the mesh wifi up yesterday so that i can mapped whole area (my desk to Dr. Block room to front door can then come back to my desk). And I order 6 more!
